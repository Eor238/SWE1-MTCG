...
namespace SWE1_MTCG
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ICard Acard2 = new MonsterCard("Dragon", 2000, Element.Fire, MonsterTypes.Dragon);
            ICard Acard3 = new MonsterCard("Dragon", 2000, Element.Fire, MonsterTypes.Dragon);
            ICard Acard4 = new MonsterCard("Dragon", 2000, Element.Fire, MonsterTypes.Dragon);

            ICard Bcard1 = new MonsterCard("Goblin", 1000, Element.Normal, MonsterTypes.Goblin);
            ICard Bcard2 = new MonsterCard("Dragon", 2000, Element.Fire, MonsterTypes.Dragon);
            ICard Bcard3 = new MonsterCard("Dragon", 2000, Element.Fire, MonsterTypes.Dragon);
            ICard Bcard4 = new MonsterCard("Dragon", 2000, Element.Fire, MonsterTypes.Dragon);
